...
import 'package:f_38/providers/firebase_providers.dart';
...
class CommunityRepository {
  ...
  //sadece user için community, tüm communityler degil
  //check
    ...
    return _communities
        .where("name",
            isGreaterThanOrEqualTo: query.isEmpty
                ? 0
                : query, //bu condition yazılmazsa tüm communityler görülür
