...
class _BreakingNews extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    void navigateToArticle(BuildContext context, String id) {
      Routemaster.of(context).push('/article/$id');
    }
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      final Article tappedArticle = articles[index];
                      final String articleId = tappedArticle.id;
